...
def home():
    ...
    _courses = SubjectContainer.query.paginate(per_page=2, page=page)
...
def search():
    ...
    if not results.items:
        flash(f"Sorry No couses found for {request.args.get('query')}.", 'danger')
    return render_template('main/home.html', _courses=results, form=form, bool_val=False)
